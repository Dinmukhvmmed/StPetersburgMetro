    ...
    public static void main(String[] args) {
        ...
        for (; ; ) {
            try {
                ...
                logger.info("Станция отправления: " + from + ", Станция назначения: " + to);
                ...
                throw new RuntimeException("Check"); //Инициируем исключение, что бы проверить попадание логов в exception.log
            }
